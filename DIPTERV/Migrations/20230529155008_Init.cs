        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SchoolClasses_Teachers_HeadMasterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FreeBlocksID = table.Column<int>(type: "int", nullable: false),
                    TeacherID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherTimeBlock", x => new { x.FreeBlocksID, x.TeacherID });
                    table.ForeignKey(
                        name: "FK_TeacherTimeBlock_Teachers_TeacherID",
                        column: x => x.TeacherID,
                        principalTable: "Teachers",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherTimeBlock_TimeBlocks_FreeBlocksID",
                        column: x => x.FreeBlocksID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectDivisions", x => x.ID);
                    table.ForeignKey(
                        name: "FK_SubjectDivisions_SchoolClasses_SchoolClassId",
                        column: x => x.SchoolClassId,
                        principalTable: "SchoolClasses",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_SubjectDivisions_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectDivisions_SchoolClassId",
                table: "SubjectDivisions",
                column: "SchoolClassId");

            migrationBuilder.CreateIndex(
                name: "IX_SubjectDivisions_TeacherId",
                table: "SubjectDivisions",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherTimeBlock_TeacherID",
                table: "TeacherTimeBlock",
                column: "TeacherID");
        }
